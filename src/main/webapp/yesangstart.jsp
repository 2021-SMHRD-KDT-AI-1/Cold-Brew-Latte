        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-6 col-md-4">
              <h1 class="my-0 site-logo"><a href="index.html">Cold Brew Latte<span class="text-primary">.</span> </a></h1>
            </div>
              ...
              <nav class="site-navigation text-right" role="navigation">
                ...
                <div class="container">
                  ...
                  <ul class="site-menu main-menu js-clone-nav d-none d-lg-none">
                    ...
                    <li><a href="mypage.jap" class="nav-link">My Page</a></li>
                  </ul>
                </div>
              </nav>
            </div>
        ...
        <table width="1000" border="0" align="center">
          <tr>
            <td width="200" align="center"> 
              <p><a href="forecastCon.do" class="btn btn-outline-primary btn-md">START</a></p>
            </td>
          </tr>
        </table><br><br>
  </div>
